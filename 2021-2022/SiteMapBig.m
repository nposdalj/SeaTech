...
m_proj('Mercator','long',[-85 -68],'lat',[24 45]); %identify ranges of the map (what is the max and min you want to show on the map)
...
m_grid('linest','none','tickdir','out','box','fancy','fontsize',16,'xtick',4);
...
%% Save plot
%png
filename = [SaveDir,'\SiteMapBig.png'];
