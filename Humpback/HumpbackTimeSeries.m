...
humpDet04 = table2array(readtable('C:\Users\HARP\Documents\GitHub\SeaTech\Humpback\humpbackCB10.csv'))
humpDet05 = table2array(readtable('D:\Mentoring\Seatech\HumpbackDetections\GofAK_CB_10_Detections_forPlots\humpbackCB10.csv'))

%% Calculating calling hour per day/month from the automatic detector


datenum05 = datestr(humpDet05(:, 1))
datenum05(:, 8) = '2'
datenum05(:, 9) = '0'
datenum05 = datenum(datenum05)
daydate05start = datenum(dateshift(datetime(datestr(datenum05)), 'start', 'day'))

datenum05end = datestr(humpDet05(:, 2))
datenum05end(:, 8) = '2'
datenum05end(:, 9) = '0'
datenum05end = datenum(datenum05end)
daydate05end = datenum(dateshift(datetime(datestr(datenum05end)), 'start', 'day'))
spdatenums = [datenum05 datenum05end];



Z_rowstart = daydate05start
Z_rowend = daydate05end
...
datenum41 = datestr(humpDet41(:, 1))
datenum41(:, 8) = '2'
datenum41(:, 9) = '0'
datenum41 = datenum(datenum41)
daydate41start = datenum(dateshift(datetime(datestr(datenum41)), 'start', 'day'))

datenum41end = datestr(humpDet41(:, 2))
datenum41end(:, 8) = '2'
datenum41end(:, 9) = '0'
datenum41end = datenum(datenum41end)
daydate41end = datenum(dateshift(datetime(datestr(datenum41end)), 'start', 'day'))


Z_rowstart = daydate41start
Z_rowend = daydate41end
