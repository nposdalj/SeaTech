...
filePrefix = 'GofAK_CB_10'; % File name to match. 
siteabrev = 'CB'; %abbreviation of site.
titleNAME = 'Gulf of Alaska - Continental Slope';
WorkspaceDir = 'I:\My Drive\GofAK_TPWS_metadataReduced\SeasonalityAnalysis\CB';
...
title({'Presence of Sperm Whales and Fishing Vessels','at the Continental Slope Site in the Gulf of Alaska'})
%grid off